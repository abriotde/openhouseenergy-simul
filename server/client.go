...
func (client OpenHouseEnergyModuleClient) GetAlertHistory() ([]*messages.GetAlertHistoryReply_Alert, error) {
...
func (client OpenHouseEnergyModuleClient) Set(varName string, varValue int32) (string, error) {
